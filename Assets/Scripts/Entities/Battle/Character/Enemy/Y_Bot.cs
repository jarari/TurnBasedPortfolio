    ...
    public class Y_Bot : Character
    {
        ...
        private void OnAnimationEvent_Impl(Character c, string animEvent, string payload)
        {
            ...
            if (animEvent == "PlaySound_1")
            {
                ...
                SoundManager.instance.PlayVOSound(this, "Enemy_Y_Bot_Normal_Attack");
            }
            if (animEvent == "PlaySound_2")
            {
                SoundManager.instance.PlayVOSound(this, "Enemy_Y_Bot_Skill_Attack1");
            }
            if (animEvent == "PlaySound_3")
            {
                SoundManager.instance.PlayVOSound(this, "Enemy_Y_Bot_Skill_Attack2");
            }
